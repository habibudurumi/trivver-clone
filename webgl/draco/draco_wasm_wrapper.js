...
$jscomp.polyfill(
    ...
    function(f) {
        ...
        h.race = function(e) {
            return new h(function(f, h) {
                for (
                    var l = $jscomp.makeIterator(e), m = l.next(); !m.done; m = l.next()
                )
...
var DracoDecoderModule = (function() {
    ...
    return function(m) {
        ...
        function ma(k) {
            function c() {
                if (!fa && ((fa = !0), !za)) {
                    ...
                    if (a.postRun)
                        for (
                            'function' == typeof a.postRun && (a.postRun = [a.postRun]); a.postRun.length;
            ...
            if (!(0 < aa)) {
                if (a.preRun)
                    for (
                        'function' == typeof a.preRun && (a.preRun = [a.preRun]); a.preRun.length;
        ...
        if (a.preInit)
            for (
                'function' == typeof a.preInit && (a.preInit = [a.preInit]); 0 < a.preInit.length;
